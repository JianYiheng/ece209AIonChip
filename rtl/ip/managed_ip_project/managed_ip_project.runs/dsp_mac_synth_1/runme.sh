...
HD_PWD='/home/beihai/Documents/ece209_lei/209-Project/OptionC/rtl/ip/managed_ip_project/managed_ip_project.runs/dsp_mac_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dsp_mac.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dsp_mac.tcl
